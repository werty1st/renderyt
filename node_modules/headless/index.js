...
module.exports = function headless(options, startnum, callback) {
  ...
  findFreeServernum(startnum, function(servernum) {
    ...
    if (!options) {
      ...
      var childProcess = spawn('Xvfb', [':' + servernum , '-screen' , '0' , options.display.width + 'x' + options.display.height + 'x' + (options.display.depth || 16) + "+32" ]);
    }
    ...
    function onExit() {
      ...
      servernum++;
      headless(options, servernum, callback);
    }
